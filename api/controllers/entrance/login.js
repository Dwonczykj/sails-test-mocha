...
and exposed as \`req.me\`.)`
  ...
  fn: async function ({ emailAddress, password, rememberMe }) {
    ...
    sails.log.info('Locating User record for ' + emailAddress);
    console.log('Locating User record for ' + emailAddress);
    ...
    sails.log.info('User record located for ' + emailAddress);
